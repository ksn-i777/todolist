...
import { TodolistFilterValuesType, TodolistType } from 'features/todolists/todolists-reducer'
import { TasksType, DomainTaskType } from 'features/tasks/tasks-reducer'
          ...
          <Paper style={{ padding: '10px', backgroundColor: '' }} elevation={3}>
            <Grid item>
              <div>
                ...
                <AddItemForm what={'todolist title'} callback={addTodolist} />
              </div>
            </Grid>
          </Paper>
        </Grid>
